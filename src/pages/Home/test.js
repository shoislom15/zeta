...
export default function test() {
  return (
    <>
      <div className="absolute top-40 w-80 MuiBox-root css-wwaq0i ">
        <svg
      ...
      <div className="absolute animate-[spin_70s_linear_infinite] z-50 w-8/12 MuiBox-root css-8a98gv">
        <div
      ...
      <div className="absolute  z-0 w-9/12 MuiBox-root css-1f0kg3b">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="100%"
          height="100%"
      ...
      <div className="MuiBox-root bg-white translate-x-36 css-fwb3y">
        <div style={{ transform: "none" }}>
          <div className="css-1vm9u4n">
            <span className="MuiBox-root css-169ynuw">
              <span
            ...
            <div className="MuiBox-root css-1isemmb">Accounting</div>
          </div>
        </div>
      </div>

      <div className="MuiBox-root relative css-94jdlp">
        <div className="MuiBox-root css-160ir84">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="100%"
            height="100%"
        ...
        <div className="MuiBox-root css-kz6zhh">
          <div style={{ transform: "none" }}>
            <div className="css-1vm9u4n">
              <span className="MuiBox-root css-169ynuw">
                <span
              ...
              <div className="MuiBox-root css-1isemmb">Banking</div>
            </div>
          </div>
        </div>
        <div className="MuiBox-root css-kyv7a">
          <div style={{ transform: "none" }}>
            <div className="css-1vm9u4n">
              <span className="MuiBox-root css-169ynuw">
                <span
              ...
              <div className="MuiBox-root css-1isemmb">Health Care</div>
            </div>
          </div>
        </div>
        <div className="MuiBox-root css-20n98i">
          <div style={{ transform: "none" }}>
            <div className="css-1vm9u4n">
              <span className="MuiBox-root css-169ynuw">
                <span
              ...
              <div className="MuiBox-root css-1isemmb">Software</div>
            </div>
          </div>
        </div>
        <div className="MuiBox-root css-10zjcuk">
          <div style={{ transform: "none" }}>
            <div className="MuiBox-root css-ujfyhr">
              <div className="MuiBox-root css-17fhzx3">
                <div className="css-1dvjcg5">
                  <div className="css-1e7hy3l"></div>
                  <div className="css-14ktxqi"></div>
                  <span className="MuiBox-root css-r2831t"></span>
                </div>
              </div>
            </div>
          </div>
        </div>
        <div className="MuiBox-root css-135572c">
          <div style={{ transform: "none" }}>
            <div className="MuiBox-root css-1jtvnsb">
              <div className="MuiBox-root css-1nojy7w">
                <div className="css-aukk4e">
                  <div className="css-2wzb7x"></div>
                  <div className="css-14ktxqi"></div>
                  <span className="MuiBox-root css-nu7wy5"></span>
                </div>
              </div>
            </div>
          </div>
        </div>
        <div className="MuiBox-root css-v03zsy">
          <div style={{ transform: "none" }}>
            <div className="MuiBox-root css-1tnbfit">
              <div className="MuiBox-root css-1uzs3ii">
                <div className="css-1pyscfq">
                  <div className="css-nlqqvb"></div>
                  <div className="css-14ktxqi"></div>
                  <span className="MuiBox-root css-1wdqvbm"></span>
                </div>
              </div>
            </div>
          </div>
